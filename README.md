...
> If you prefer to use your own messaging service to manage server-to-device communication, use the [sync](https://docs.hypertrack.com/#references-sdks-ios) method.
...
> [deviceID](https://docs.hypertrack.com/#references-sdks-ios-deviceid) to retrieve it.
...
You can find API references in our [docs](https://docs.hypertrack.com/#references-sdks-ios). There is also a full in-code reference for all SDK methods.
